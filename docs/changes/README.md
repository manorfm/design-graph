...
> código a priori — mesmo padrão de origem do C35, C36, C37 e C38. C34 é uma
> segunda rodada de auditoria sobre C25–C33, não um change de feature. C35,
> C36, C37 e C38 são o mesmo tipo de achado: relato externo verificado contra
> o código e transformado em bug real (C35: "design-graph não expõe media
...
> "textos não têm escape hatch sem corte, e o componente raiz `App` nunca
> aparece como tela").
